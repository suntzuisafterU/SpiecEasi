...
pr.mb  <- huge.pr(subset(se1$mb$est$path), getRefit(se2$mb)[ind2,ind2], verbose=FALSE)
pr.gl  <- huge.pr(subset(se1$glasso$est$path), getRefit(se2$glasso)[ind2,ind2], verbose=FALSE)
pr.slr <- huge.pr(subset(se1$slr$est$path), getRefit(se2$slr)[ind2,ind2], verbose=FALSE)
